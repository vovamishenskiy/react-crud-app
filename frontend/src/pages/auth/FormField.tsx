  ...
  return (
    <>
      <FormControl fullWidth className={classes.formControl}>
        <FormLabel classes={{ root: classes.formLabel }}>Логин</FormLabel>
        <TextField
          fullWidth
          name='username'
      ...
      {isRegister ? (
        <FormControl fullWidth className={classes.formControl}>
          <FormLabel classes={{ root: classes.formLabel }}>Почта</FormLabel>
          <TextField
            fullWidth
            name='email'
            value={values.email}
      ...
      <FormControl fullWidth className={classes.formControl}>
        <FormLabel classes={{ root: classes.formLabel }}>Пароль</FormLabel>
        <TextField
          fullWidth
          type='password'
          name='password'
